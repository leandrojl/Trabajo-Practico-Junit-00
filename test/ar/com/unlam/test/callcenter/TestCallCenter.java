...
public class TestCallCenter {
	...
	@Test
	public void queUnOperadorHagaUnaLlamadaYSeaExistosa() {
		...
		operador.realizarLlamada(candidato);
		operador.cambiarEstadoDelClienteDelCandidato(candidato,"Ser cliente");
		operador.cambiarEstadoDelClienteDeSerLlamado(candidato,"No ser llamado");
		Boolean valorEsperado= operador.llamadaExitosa(candidato);
		
		Assert.assertEquals(valorEsperado, candidato.getEsCliente());
	...
	@Test
	public void queUnOperadorHagaUnaLlamadaYNoSeaExistosaYNoSeaLlamado() {
		...
		operador.realizarLlamada(candidato);
		operador.cambiarEstadoDelClienteDelCandidato(candidato,"No ser cliente");
		operador.cambiarEstadoDelClienteDeSerLlamado(candidato, "No ser llamado");
		Boolean valorEsperado= operador.llamadaExitosa(candidato);
